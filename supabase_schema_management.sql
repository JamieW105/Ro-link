...
CREATE TABLE IF NOT EXISTS public.management_roles (
    ...
    permissions TEXT[] DEFAULT '{}', -- ['RO_LINK_DASHBOARD', 'MANAGE_SERVERS', 'POST_JOB_APPLICATION', 'POST_UPDATES', 'BLOCK_SERVERS', 'MANAGE_MODULES', 'SITE_TESTING_ACCESS', 'MANAGE_RO_LINK']
...
VALUES ('Super Admin', ARRAY['RO_LINK_DASHBOARD', 'MANAGE_SERVERS', 'POST_JOB_APPLICATION', 'POST_UPDATES', 'BLOCK_SERVERS', 'MANAGE_MODULES', 'SITE_TESTING_ACCESS', 'MANAGE_RO_LINK'])
ON CONFLICT (name) DO NOTHING;

UPDATE public.management_roles
SET permissions = ARRAY(
    SELECT DISTINCT permission
    FROM unnest(COALESCE(permissions, ARRAY[]::TEXT[]) || ARRAY['POST_UPDATES', 'MANAGE_MODULES', 'SITE_TESTING_ACCESS']) AS permission
)
