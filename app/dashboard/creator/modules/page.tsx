                ...
                <div className="rl-dashboard-nav-inner rl-shell">
                    ...
                    <div className="rl-dashboard-account">
                        ...
                        <div className="rl-dashboard-avatar-wrap">
                            {userAvatarUrl
                                ? <img src={userAvatarUrl} alt="" className="rl-dashboard-avatar" />
                                : <span className="rl-dashboard-avatar inline-flex items-center justify-center bg-slate-900 text-slate-500"><UserRound size={16} aria-hidden="true" /></span>}
