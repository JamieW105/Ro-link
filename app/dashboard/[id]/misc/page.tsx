...
import { Search as LucideSearch, User as LucideUser, WandSparkles as LucideWandSparkles } from 'lucide-react';
...
const MagicIcon = () => (
    <LucideWandSparkles width="18" height="18" strokeWidth="2" />
);

const UserIcon = () => (
    <LucideUser width="14" height="14" strokeWidth="2" />
);
