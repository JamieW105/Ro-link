...
import { canManageStaffNotes, requireDashboardAccess, trimString } from '@/lib/serverDashboardAccess';
...
export async function GET(req: NextRequest) {
    ...
    const access = await requireDashboardAccess(serverId, canManageStaffNotes);
    if ('error' in access) {
        return access.error;
    }
