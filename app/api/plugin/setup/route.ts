...
import { installStudioPluginServer, requireAuthorizedStudioPluginSession, StudioPluginError } from '@/lib/studioPlugin';
...
export async function POST(req: Request) {
    try {
        ...
        console.error('[PLUGIN][SETUP] Failed to store Ro-Link setup', {
